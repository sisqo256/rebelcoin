...
Usage:
    PYTHONPATH=../../test/functional/test_framework ./gen_key_io_test_vectors.py valid 50 > ../../rebelcoin/test/data/key_io_valid.json
    PYTHONPATH=../../test/functional/test_framework ./gen_key_io_test_vectors.py invalid 50 > ../../rebelcoin/test/data/key_io_invalid.json
'''
...
bech32_templates = [
  ...
  ('"rebelcoin',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('"rebelcoin',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('"rebelcoin',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('trebelcoin',    0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('trebelcoin',    0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('trebelcoin',    2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rrebelcoin',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rrebelcoin',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rrebelcoin', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('trebelcoin',   17, 32, False, False, False),
  ('rrebelcoin',  3,  1, False, False, False),
  ('rebelcoin',   15, 41, False, False, False),
  ('trebelcoin',    0, 16, False, False, False),
  ('rrebelcoin',  0, 32, True,  False, False),
  ('rebelcoin',    0, 16, True,  False, False),
  ('trebelcoin',    0, 32, False, True,  False),
  ('rrebelcoin',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['rebelcoin', 'trebelcoin', 'rrebelcoin']:
