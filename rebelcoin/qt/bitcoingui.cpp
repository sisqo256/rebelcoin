    ...
    m_network_style(networkStyle)
{
    ...
    // Create status bar
    statusBar();
    statusBar()->setStyleSheet("QWidget { background-color: #080809; font-weight:bold; text-align:center; font-family: Arial, sans-recif; font-size: 9px; text-transform: uppercase; color: #A5A5A5;} ");
    ...
    unitDisplayControl->setStyleSheet("QLabel { background-color: #080809; font-weight:bold; text-align:center; font-family: Arial, sans-recif; font-size: 9px; text-transform: uppercase; color: #A5A5A5;} QLabel::item:selected { background-color: #232323;} QLabel::item:pressed { background-color: #232323;}");
    ...
    // See https://doc.qt.io/qt-5/gallery.html
        progressBar->setStyleSheet("QProgressBar { background-color: #141414; font-size: 0px; font-family: Diversa Sans Com Black, sans-recif; font-weight: normal; max-height: 2px; color: transparent; border: 1px solid grey; border-radius: 10px; padding: 1px; text-align: center; min-width: 400px; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #212121, stop: 1 #FF0000); font-size: 0px; border-radius: 14px; margin: 0px; max-height: 2px; min-width: 400px; } ");
...
void BitcoinGUI::createActions()
{
...
#endif
    sendCoinsAction->setStatusTip(tr("Send coins to a Rebelcoin address"));
...
#endif
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rebelcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rebelcoin addresses to prove you own them"));
    ...
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rebelcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a rebelcoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Rebelcoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Rebelcoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
