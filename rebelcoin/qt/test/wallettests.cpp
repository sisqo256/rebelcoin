...
//
//     QT_QPA_PLATFORM=xcb     rebelcoin/qt/test/test_rebelcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows rebelcoin/qt/test/test_rebelcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   rebelcoin/qt/test/test_rebelcoin-qt  # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: rebelcoin:")) != -1);
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_rebelcoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI();
