    ...
    platformStyle(_platformStyle)
{
    ...
    if (!_platformStyle->getImagesOnButtons()) {
        ...
        ui->sendButton->setIcon(_platformStyle->SingleColorIcon(":/icons/send0"));
    }
...
*/
  ...
  //  QString questionString = tr("Are you sure you want to send?");
    ...
    questionString.append("<br /><span style='color:#999999; font-size:10pt;'>");
    ...
    if(txFee > 0)
    {
        ...
        questionString.append("<hr /><b><span style='color:#999999; font-size:10pt; font-weight:normal;'>");
        questionString.append(tr("Transaction fee"));
        questionString.append("</b></span>");

        // append transaction size
        questionString.append("<span style='color:#999999; font-size:10pt; font-weight:normal;'> (" + QString::number((double)currentTransaction.getTransactionSize() / 1000) + " kB): </span>");

        // append transaction fee value
        questionString.append("<span style='color:#7C4600; font-weight:bold;'>");
        questionString.append(BitcoinUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), txFee));
        questionString.append("</span><br />");

        // append RBF message according to transaction's signalling
        questionString.append("<span style='color:#999999; font-size:10pt; font-weight:normal;'>");
 ...
 //   questionString.append(QString("<b>%1</b>: <b>%2</b>").arg(tr("Total Amount"))
    ...
    questionString.append(QString("<br /><span style='color:#999999; font-size:10pt; font-weight:normal;'>(=%1)</span>")
...
void SendCoinsDialog::updateSmartFeeLabel()
{
    ...
    if (reason == FeeReason::FALLBACK) {
        ...
        QColor warning_colour(170 - (lightness / 5), 170 - (lightness / 5), 170 - (lightness / 5));
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        CoinControlDialog::coinControl()->destChange = CNoDestination();
        ui->labelCoinControlChangeLabel->setStyleSheet("QLabel{color:#816426;}");
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Rebelcoin address"));
        }
        else // Valid address
        {
