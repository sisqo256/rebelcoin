...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " rebelcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  rebelcoin-tx [options] <hex-tx> [commands]  Update hex-encoded rebelcoin transaction\n" +
            "or:     rebelcoin-tx [options] -create [commands]   Create hex-encoded rebelcoin transaction\n" +
            "\n";
