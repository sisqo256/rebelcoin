...
static UniValue getpeerinfo(const JSONRPCRequest& request)
{
            ...
            "    \"subver\": \"/RBL:1.0.0/\",  (string) The string version\n"
...
static UniValue disconnectnode(const JSONRPCRequest& request)
{
            RPCHelpMan{"disconnectnode",
                ...
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"192.168.0.6:10505\"")
            + HelpExampleCli("disconnectnode", "\"\" 1")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:10505\"")
...
static UniValue getaddednodeinfo(const JSONRPCRequest& request)
{
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:10505\",  (string) Rebelcoin server IP and port we're connected to\n"
...
static UniValue getnetworkinfo(const JSONRPCRequest& request)
{
            ...
            "  \"subversion\": \"/RBL:x.x.x/\",     (string) the server subversion string\n"
