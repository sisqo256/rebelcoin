...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        raw_tx = self.nodes[1].createrawtransaction(inputs, outputs).replace("c0800842", "00000000")  # replace 11.11 with 0.0 (int32)
        ...
        assert_raises_rpc_error(-5, "Invalid Rebelcoin address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid Bitcoin address
        assert_raises_rpc_error(-5, "Invalid Rebelcoin address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid Rebelcoin address or script", self.nodes[0].importaddress, "invalid")
