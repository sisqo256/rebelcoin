...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def bitcoin_wallet_process(self, *args):
        binary = self.config["environment"]["BUILDDIR"] + '/rebelcoin/rebelcoin-wallet' + self.config["environment"]["EXEEXT"]
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `rebelcoin-wallet help` raises an error. Use `rebelcoin-wallet -help`.
