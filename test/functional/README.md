...
- `/rebelcoin/rpc/*` for RPCs
- `/rebelcoin/wallet/rpc*` for wallet RPCs
- `ProcessMessage()` in `/rebelcoin/net_processing.cpp` for parsing P2P messages
...
with rebelcoind(s) being tested in a callback-based event loop; the other
