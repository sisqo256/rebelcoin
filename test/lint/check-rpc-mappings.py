...
SOURCES = [
    "rebelcoin/rpc/server.cpp",
    "rebelcoin/rpc/blockchain.cpp",
    "rebelcoin/rpc/mining.cpp",
    "rebelcoin/rpc/misc.cpp",
    "rebelcoin/rpc/net.cpp",
    "rebelcoin/rpc/rawtransaction.cpp",
    "rebelcoin/wallet/rpcwallet.cpp",
]
# Source file (relative to root) containing conversion mapping
SOURCE_CLIENT = 'rebelcoin/rpc/client.cpp'
