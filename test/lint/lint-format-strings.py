...
FALSE_POSITIVES = [
    ("rebelcoin/dbwrapper.cpp", "vsnprintf(p, limit - p, format, backup_ap)"),
    ("rebelcoin/index/base.cpp", "FatalError(const char* fmt, const Args&... args)"),
    ("rebelcoin/netbase.cpp", "LogConnectFailure(bool manual_connection, const char* fmt, const Args&... args)"),
    ("rebelcoin/util/system.cpp", "strprintf(_(COPYRIGHT_HOLDERS).translated, COPYRIGHT_HOLDERS_SUBSTITUTION)"),
    ("rebelcoin/wallet/wallet.h",  "WalletLogPrintf(std::string fmt, Params... parameters)"),
    ("rebelcoin/wallet/wallet.h", "LogPrintf((\"%s \" + fmt).c_str(), GetDisplayName(), parameters...)"),
    ("rebelcoin/logging.h", "LogPrintf(const char* fmt, const Args&... args)"),
]
