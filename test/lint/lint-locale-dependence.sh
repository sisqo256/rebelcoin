...
export LC_ALL=C
KNOWN_VIOLATIONS=(
    "rebelcoin/bitcoin-tx.cpp.*stoul"
    "rebelcoin/bitcoin-tx.cpp.*trim_right"
    "rebelcoin/dbwrapper.cpp.*stoul"
    "rebelcoin/dbwrapper.cpp:.*vsnprintf"
    "rebelcoin/httprpc.cpp.*trim"
    "rebelcoin/init.cpp:.*atoi"
    "rebelcoin/qt/rpcconsole.cpp:.*atoi"
    "rebelcoin/rest.cpp:.*strtol"
    "rebelcoin/test/dbwrapper_tests.cpp:.*snprintf"
    "rebelcoin/torcontrol.cpp:.*atoi"
    "rebelcoin/torcontrol.cpp:.*strtol"
    "rebelcoin/util/strencodings.cpp:.*atoi"
    "rebelcoin/util/strencodings.cpp:.*strtol"
    "rebelcoin/util/strencodings.cpp:.*strtoul"
    "rebelcoin/util/strencodings.h:.*atoi"
    "rebelcoin/util/system.cpp:.*atoi"
)

REGEXP_IGNORE_EXTERNAL_DEPENDENCIES="^rebelcoin/(crypto/ctaes/|leveldb/|secp256k1/|tinyformat.h|univalue/)"
