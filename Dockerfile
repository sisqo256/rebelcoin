...
WORKDIR /opt/
RUN wget https://github.com/sisqo256/rebelcoin/releases/download/untagged-c5896321f7cab0dbf803/rebelcoin-Linux.tar.gz
RUN tar zxvf rebelcoin-Linux.tar.gz
RUN mv rebelcoin-Linux/bin/rebelcoin* /usr/bin/
